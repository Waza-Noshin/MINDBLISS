...
class RecoAnxietyScreen(Screen):
    def __init__(self, app_instance, **kwargs):
        super(RecoAnxietyScreen, self).__init__(**kwargs)
    ...
    def setup_ui(self):
        ...
        self.music_button.bind(on_press=self.open_anxiety_music)
        ...
        self.podcast_button.bind(on_press=self.open_anxiety_podcast)
        ...
        self.stories_button.bind(on_press=self.open_anxiety_stories)
    ...
    def open_anxiety_music(self, instance):
        # Redirect to Anxiety Music Playlist on Spotify
        webbrowser.open("https://open.spotify.com/playlist/76BmZklHrndOoeJIf66hEL?si=nwYKFIdWTfyEQBZ-jkn4KQ&pi=wQBxr8IkQ3m3t")

    def open_anxiety_podcast(self, instance):
        # Redirect to Anxiety Podcast Playlist on Spotify
        webbrowser.open("https://open.spotify.com/show/27HBe9LeXScayiSbidbDiO?si=ThIe1fIOQhO-peJTKT9snA")

    def open_anxiety_stories(self, instance):
        # Redirect to Anxiety Success Stories Playlist on Spotify
        webbrowser.open("https://youtube.com/playlist?list=PLfX83djbCFH_l3l2UTlqpOJOjZT-Km6TH&si=JbE1JKyimA0KX6eV")
