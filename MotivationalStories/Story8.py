...
class StoryScreen(Screen):
    def __init__(self, app, **kwargs):
        ...
        self.bg = Image(source=os.path.abspath("E:/WAZA/PRO/MotivationalStories/story8.png"),
        ...
        headline_label = Label(
            text="[b]The Pencil and the Eraser[/b]",
            font_size="38sp",
            halign="center",
            valign="middle",
        ...
        paragraph1 = """A pencil and an eraser were best friends. One day, the pencil said, 
        “I’m sorry, every time I make a mistake, you lose a part of yourself.”"""

        paragraph2 = """The eraser smiled and replied, 
        “That’s what I’m here for. Mistakes help you grow, and I’m happy to be part of your journey.”"""

        paragraph3 = """The pencil realized that learning comes with mistakes, 
        and having someone to support you makes the journey worthwhile."""
        ...
        moral_label = Label(
            text="🌿 [b]Moral:[/b] Mistakes are part of learning. Don’t be afraid to make them.",
            font_size="24sp",
            halign="center",
            valign="middle",
